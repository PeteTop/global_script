...
class AdminSpec {
    static async run() {
        ...
        try {
                ...
                await page.type('#_e_14 > table > tbody > tr:nth-child(2) > td:nth-child(2) > div > input', admin.name, {
                    delay: 30
                })
                await page.type('#_e_16 > table > tbody > tr:nth-child(2) > td:nth-child(2) > div > input', admin.pwd, {
                    delay: 30
                })
